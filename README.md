...
[![image](https://img.shields.io/pypi/v/ty/0.0.21.svg)](https://pypi.python.org/pypi/ty)
[![image](https://img.shields.io/pypi/l/ty/0.0.21.svg)](https://pypi.python.org/pypi/ty)
[![image](https://img.shields.io/pypi/pyversions/ty/0.0.21.svg)](https://pypi.python.org/pypi/ty)
...
- repo: https://github.com/allganize/ty-pre-commit
  # Ty version.
  rev: v0.0.21a35a34a33a32a31a30a29a28a27a26a25a24a23a22a21a20
  hooks:
