...
[![image](https://img.shields.io/pypi/v/ty/0.0.1a28.svg)](https://pypi.python.org/pypi/ty)
[![image](https://img.shields.io/pypi/l/ty/0.0.1a28.svg)](https://pypi.python.org/pypi/ty)
[![image](https://img.shields.io/pypi/pyversions/ty/0.0.1a28.svg)](https://pypi.python.org/pypi/ty)
...
- repo: https://github.com/allganize/ty-pre-commit
  # Ty version.
  rev: v0.0.1a28a27a26a25a24a23a22a21a20
  hooks:
